...
//        try {
//            FileInputStream fileInputStream = new FileInputStream("/Users/admin/Desktop/wordFile/test.docx");
...
//        headStyle.setBorderBottom(CellStyle.BORDER_THICK);  //设置单元格线条
...
//        headStyle.setAlignment(CellStyle.ALIGN_CENTER);    //设置水平对齐方式
//        headStyle.setVerticalAlignment(CellStyle.VERTICAL_CENTER);  //设置垂直对齐方式
//        //headStyle.setShrinkToFit(true);  //自动伸缩
//        headStyle.setFont(headFont);  //设置字体
//        /*设置数据单元格格式*/
//        CellStyle dataStyle = wb.createCellStyle();
//        dataStyle.setBorderBottom(CellStyle.BORDER_THIN);  //设置单元格线条
...
//        dataStyle.setAlignment(CellStyle.ALIGN_LEFT);    //设置水平对齐方式
//        dataStyle.setVerticalAlignment(CellStyle.ALIGN_CENTER);  //设置垂直对齐方式
